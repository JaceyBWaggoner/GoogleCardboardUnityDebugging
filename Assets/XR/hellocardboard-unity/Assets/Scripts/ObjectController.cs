...
public class ObjectController : MonoBehaviour
{
    ...
    {
		if(UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "HelloCardboard")
		{
			UnityEngine.SceneManagement.SceneManager.LoadScene("HelloCardboard_Scene2");
		}
		else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "HelloCardboard_Scene2")
		{
			UnityEngine.SceneManagement.SceneManager.LoadScene("HelloCardboard");
		}
